...
export default function App() {
   return (
     <main className="min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items">
      <section className="lg:flex">
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <h2 className="font-shoulders mb-7 uppercase text-4xl font-bold text-offwhitebg" mb-7>Luxuosos</h2>
          ...
          <a className="font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-dark-green" href="https://www.webmotors.com.br/carros-de-luxo/carros/estoque" target="_blank">Ver mais</a>
